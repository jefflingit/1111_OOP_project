...
public class STAT extends Department{
    /**
     * The required credits that are needed
     */
    final double REQUIREDCREDITS=45.0;
    /**
     * The partially required credits that are needed
     */
    final double PARTIALLYREQUIREDCREDITS=15.0;
    /**
     ...
     */
    final double PARTIALLYREQUIREDCREDITSB=6.0;
    /**
     * The partially required credits of category Cc that are needed
     */
    final double PARTIALLYREQUIREDCREDITSC=6.0;
    /**
    ...
    //傳入系所規定的群修課程
    /**
     * Use the super method to add partiallyRequiredCredits threshold information to STAT.
     * @throws IOException
     */
    public void addPartiallyRequired() throws IOException {
        super.addRequire("STAT_partiallyRequiredA.csv",this.deptPartiallyRequired1);
        super.addRequire("STAT_partiallyRequiredB.csv",this.deptPartiallyRequired2);
    }
    ...
    public void partiallyRequiredJudgement(ArrayList<Course> courses){
        ...
        if (partiallyRequiredCredits2 < 6){
            requirements.set(5, true);
            System.out.println("群B未滿");
        }
        if (partiallyRequiredCredits3 < 6){
